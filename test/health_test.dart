...
//   late final List<HealthDataAccess> permissions;

//   @override
//   void initState() {
//     super.initState();

//     // Set permissions based on types
//     permissions = types
//         .map((type) => [
//               HealthDataType.GENDER,
//               HealthDataType.BLOOD_TYPE,
...
//           await health.requestAuthorization(types, permissions: permissions);
//     } catch (e) {
//       debugPrint("Exception during HealthKit authorization: $e");
//     }
...
//   /// Fetch data from HealthKit (last 24 hours)
...
//     } catch (e) {
//       debugPrint("Exception fetching health data: $e");
...
//       setState(() {
//         _nofSteps = steps ?? 0;
//         _state = AppState.STEPS_READY;
//       });
//     } catch (e) {
//       debugPrint("Exception fetching steps: $e");
//       setState(() => _state = AppState.NO_DATA);
//     }
//   }
...
//     return MaterialApp(
//       home: Scaffold(
//         appBar: AppBar(title: const Text('HealthKit Example')),
//         body: Column(
//           children: [
//             Wrap(
//               spacing: 10,
//               children: [
//                 TextButton(
//                   onPressed: authorizeHealthKit,
//                   child: const Text("Authorize HealthKit"),
//                 ),
//                 TextButton(
...
//         return const Center(
//             child: Text("Press 'Authorize' to access Health data."));
//       case AppState.AUTHORIZED:
//         return const Center(child: Text("Authorization granted!"));
...
//         return Center(child: Text("Total Steps Today: $_nofSteps"));
