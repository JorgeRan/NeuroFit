...
import 'package:neurofit_app/features/workout/presentation/screens/my_routines_screens.dart';
...
import 'package:neurofit_app/shared/presentation/graphs.dart';
...
class ExerciseScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final numRoutines = ref.watch(allRoutinesProvider).length;
    final numWorkouts = ref.watch(allWorkoutsProvider).length;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => MyRoutinesScreens(),
                      ),
                    );
                  },
              ...
              InteractiveBody(false, isFront: isFront),
              SizedBox(
                height: 20,
              ),
              Card(
